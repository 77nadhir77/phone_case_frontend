                    ...
                    <div className="flex">
                        <div className="shrink-0 flex items-center">
                            <img
                                ...
                                alt="Logo"
                            />
                            <span className="ml-2 text-xl font-bold text-secondary">Phone covers</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center w-fit justify-between">
                        {
                            ...
                            <>
                                ...
                                {user.role === "admin" && (
                                    <Link to="/dashboard" className="text-gray-500 hover:text-gray-700 inline-flex justify-between items-center px-1 pt-1 text-sm font-medium w-24">
                                        Dashboard✨
                                    </Link>
                                )}
                                <Link
